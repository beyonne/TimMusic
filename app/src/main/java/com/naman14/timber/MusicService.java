...
//            }
    ...
    private static final class MultiPlayer implements MediaPlayer.OnErrorListener,
        ...
        public void SetSpeed() {
            mCurrentMediaPlayer.setPlaybackParams(mCurrentMediaPlayer.getPlaybackParams().setSpeed(1.5f));
        }
        ...
        @Override
        public void onCompletion(final MediaPlayer mp) {//播放完毕
            if (mp == mCurrentMediaPlayer && mNextMediaPlayer != null) {//切换到下一首
                mCurrentMediaPlayer.release();
